...
liste_abonnee::liste_abonnee()
{

}
int liste_abonnee::ajouter_abonne(int cin,QString nom,QString prenom,int age,QString adresse_mail,QString date_debut,QString date_fin,float prix)
{
    QSqlQuery query;
...
bool liste_abonnee::ajouter_abonne(const eleve &el)
{
    QSqlQuery query;

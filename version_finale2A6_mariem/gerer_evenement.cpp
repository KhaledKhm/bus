    ...
    ui(new Ui::gerer_evenement)
{
    ...
    ui->stateven->setLayout(mainLayout);
}
...
void gerer_evenement::on_ajouter_clicked()
{
  ...
  if (verif_id==true && verif_nom==true){
...
{
    if(arg1 == "Id")
           ui->tabevent->setModel(e.tri_id());
       else if(arg1 == "Nom")
                ui->tabevent->setModel(e.tri_nom());
}
...
void gerer_evenement::on_rech_currentIndexChanged(const QString &arg1)
{
    ...
    QString Nom,season;
    if(arg1 == "Id")
           ui->tabevent->setModel(e.recherche(id));
    else if(arg1 == "Nom")
...
void gerer_evenement::on_stat2_currentchanged(int index){
    if(index==2){
        delete mainLayout;
        mainLayout=new QVBoxLayout;
        mainLayout->addWidget(s2.Preparechart());

...
rem::rem(int id,float taux , int ide , QString type)
{
  this->id=id;
  this->ide=ide;
  this->taux=taux;
...
int rem::get_id(){return  id;}
int rem::get_ide(){return ide;}
float rem::get_taux(){return taux;}
QString rem::get_type(){return type;}
bool rem::ajouter()
{
...
QSqlQueryModel * rem::afficher(){
QSqlQueryModel * model= new QSqlQueryModel();
model->setQuery("select * from Remise");
model->setHeaderData(0, Qt::Horizontal, QObject::tr("Id"));
model->setHeaderData(1, Qt::Horizontal, QObject::tr("Taux"));
model->setHeaderData(2, Qt::Horizontal, QObject::tr("Type"));
model->setHeaderData(3, Qt::Horizontal, QObject::tr("IdEvenement"));
    return model;
}

bool rem::supprimer(int id)
{
QSqlQuery query;
QString res= QString::number(id);
...
*/
QSqlQueryModel * rem::recherche(int id){
    QSqlQueryModel * model = new QSqlQueryModel();
    QString res = QString::number(id);
...
QSqlQueryModel * rem::recherche_taux(int id){
    QSqlQueryModel * model = new QSqlQueryModel();
    QString res = QString::number(id);
...
QSqlQueryModel * rem::recherche_ide(int ide){
    QSqlQueryModel * model = new QSqlQueryModel();

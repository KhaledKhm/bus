...
remi::remi(int id,float taux , int ide , QString type)
{
  this->id=id;
  this->ide=ide;
  this->taux=taux;
...
int remi::get_id(){return  id;}
int remi::get_ide(){return ide;}
float remi::get_taux(){return taux;}
QString remi::get_type(){return type;}
bool remi::ajouter()
{
...
*/
QSqlQueryModel * remi::recherche(int id){
    QSqlQueryModel * model = new QSqlQueryModel();
    QString res = QString::number(id);
...
QSqlQueryModel * remi::recherche_taux(int id){
    QSqlQueryModel * model = new QSqlQueryModel();
    QString res = QString::number(id);
...
QSqlQueryModel * remi::recherche_ide(int ide){
    QSqlQueryModel * model = new QSqlQueryModel();

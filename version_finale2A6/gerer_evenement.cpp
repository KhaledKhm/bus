...
void gerer_evenement::on_recherche_clicked(){
...
void gerer_evenement::on_rechtaux_clicked(){
    int id = ui->id_6->text().toInt();
    ui->tabetudiant->setModel(r.recherche(id));
}

void gerer_evenement::on_rechide_clicked(){
    int ide = ui->id_6->text().toInt();
    ui->tabetudiant->setModel(r.recherche(ide));
}
